...
export default function PostaJob(){
    ...
    <form className="capitalized   ">
        ...
        <input type="text" className="border flex w-42 ml-4 w-72 mt-2 mb-2 rounded p-1"/>
        </div>
        <div>
        <label htmlFor="Name"className="font-semibold ml-4">company website</label>
        <input type="text"className="border flex w-42 ml-2 p-1 rounded w-72  mt-2 mb-2" />
          </div>
        </div>
          {/* for job title */}
        <div >
            <label htmlFor="title"className="font-semibold m-1 ">Job Title</label>
            <input type="title" className="border flex w-11/12 rounded p-1 mt-2 mb-2" />
        </div>
                  {/* for job category anf types */}
        <div className="grid sm:grid-cols-1 md:grid-cols-2">               
               <div>
            <label htmlFor=""className="font-semibold">Job Category</label>
           <select name="category" id="" className="border p-1 m-1  flex w-72 mt-2 mb-2">
           ...
           <div>
            ...
            <select name="choice" className="border p-1 m-1 ml-4 w-72 flex mt-2 mb-2">
     ...
     <div>
            ...
            <input type="text"  placeholder="Location" className="border m-1 p-1 mt-2 mb-2 flex w-72"/>
            </div>

            <div>
            <label htmlFor="number"className="font-semibold">Salary Range</label>
            <input type="number" placeholder="Salary Range" className="border flex w-72 mt-2 mb-2 m-1 p-1"/>
        </div>
        </div>
      ...
      <div>
            ...
            <input type="text"  placeholder="Experience" className="border m-1 p-1 w-72 mt-2 mb-2 flex"/>
            </div>

            <div>
            <label htmlFor="text" className="font-semibold">Qualification</label> 
            <input type="text" placeholder="Qualification" className="border m-1 p-1 w-72 ml-2 mb-2 flex"/>
        </div>
      </div>
        ...
        <div>
            ...
            <input type="date" className="border flex m-1 p-1 w-96 mb-2 mt-2" placeholder=" Application deadline" />
        </div>
        <div>
            <label htmlFor="url" className="font-semibold">Job Application link url  </label>
            <input type="url" className="border flex m-1 p-1 w-96 mt-2 mb-2" placeholder="job Application link url" />
        </div>
        <div className="grid">
