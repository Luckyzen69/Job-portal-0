...
export default function FAQ(){
    ...
    <div className="flex justify-center m-4">
        <div className="border m-4 p-4 flex-row items-center list-outside ">
            <RiUserSearchLine size={34} color="#5B7FFF" className=" m-4 float-left" />
            <h2 className="font-bold text-sky-600 text-xl =">JobSeeker</h2>
            <p className="text-sky-400">Looking for job, find answer  to your quries</p>
        </div>
        <div className="border m-4 p-4 flex-row items-center list-outside ">
            <HiBuildingOffice2 size={34} color="#002a5b" className="m-4 float-left"/>
            <h2 className="font-bold text-sky-900 text-xl"> Employers</h2>
            <p className="text-sky-900">All about employers account & merojob employer services</p>
        </div>
    </div>

    <h2 className="text-gray-400 text-center font-bold text-2xl underline underline-offset-4"> Most Popular FAQs</h2>
