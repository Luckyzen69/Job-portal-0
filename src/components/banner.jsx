...
export default function Banner() {
  ...
  const [results,setResults] = useState([])
    return (
        <>
         <div className=" lg:grid-cols-1 flex justify-between relative lg:overflow-hidden  bg-light  bg-luffy  h-screen w-auto bg-no-repeat bg-fixed bg-center sm:bg-right lg:bg-right">
